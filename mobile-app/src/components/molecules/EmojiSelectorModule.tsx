...
//     setState((data) => ({ ...data, searchQuery }));
//   };
...
//   const returnSectionData = useMemo(() => {
//     const { history, emojiList, searchQuery, category } = state;
//     let emojiData = (function (emojiList) {
//       if (!emojiList) return [];
...
//       }
//     })(emojiList);
//     return props.shouldInclude
//       ? emojiData.filter((e) => props.shouldInclude(e.emoji))
//       : emojiData;
//   }, [state.emojiList, state.searchQuery, state.category, state.history]);
...
//       ...data,
//       emojiList,
//       colSize: Math.floor(state.width / props.columns),
//       isReady: true,
//     }));
//   };

//   const handleLayout = ({ nativeEvent: { layout } }) => {
//     setState((data) => ({ ...data, width: layout.width }));
//     prerenderEmojis();
//   };
